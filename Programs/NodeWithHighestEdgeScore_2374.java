...
class NodeWithHighestEdgeScore_2374 {
    public static void main(String[] args) {
        NodeWithHighestEdgeScore_2374 n = new NodeWithHighestEdgeScore_2374();
        System.out.println( n.edgeScore(new int[]{25,27,27,21,39,30,38,17,36,23,23,2,34,39,11,36,15,29,35,36,39,3,30,29,33,0,33,21,41,21,36,36,35,35,19,36,42,19,28,11,44,11,30,6,11}));
    }
